...
class MeasurementImages(ELNMeasurement, PlotSection, ArchiveSection):
    '''
    Class for handling measurement of SEM.
    '''
    m_def = Section(
        categories=[CRC1415CategoryMeasurement],
        label='CRC1415-Measurement-Images',
        a_eln={
            "overview": True,
            "hide": [
                #"name",
    ...
    name = Quantity(
        type=str,
        #default='TestName',
        description='Name of the section of image measurement',
        a_eln={'component': 'StringEditQuantity', 'label': 'Image: Brief title of the measurement'},
    )
    ...
    data_image_files = Quantity(
        ...
        shape=["*"],
        description='''
        A reference to an uploaded image file (*.tif, *.jpeg, *.png).
        ''',
        a_tabular_parser={
            "parsing_options": {
                "sep": "\\t",
    ...
    def normalize(self, archive: 'EntryArchive', logger: 'BoundLogger'):
        """
        The normalize function of the `MeasurementImages` section.
